...
/**
 * Class containing tests for our WorldWithBooleanVariable implementation.
 */
public class WorldWithBooleanVariableTest {
    
    /**
     * Method that tests the getBooleanVariables method.
    ...
    /**
     * Method that tests the getCorrespondingState method.
     * @return true if the test passed, false otherwise.
     */
    ...
    /**
     * Main method to launch the tests
     * @param args not used
     */
